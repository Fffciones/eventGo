...
import ProfissionaisAdmin from './components/ProfissionaisAdmin';
import ContratantesAdmin from './components/ContratantesAdmin';
import FuncoesAdmin from './components/FuncoesAdmin';
import EventosAdmin from './components/EventosAdmin';
import VariaveisAdmin from './components/VariaveisAdmin';
import FinanceiroAdmin from './components/FinanceiroAdmin';
import VagasAdmin from './components/VagasAdmin';
import AdminsAdmin from './components/AdminsAdmin';
